      ...
      {isOpen && car && (
        <>
          ...
          <motion.div 
            ...
            className="fixed right-0 top-0 bottom-0 w-full md:w-[600px] lg:w-[700px] bg-[#050505] border-l border-[#D4AF37]/20 shadow-2xl flex flex-col overflow-y-auto z-50"
          >
            {/* Image Header */}
            <div className="relative w-full h-[400px] shrink-0 bg-[#111]">
              <img 
                src={car.image} 
                alt={car.name} 
            ...
            <div className="p-10 md:p-14 flex flex-col flex-1 bg-[#050505] z-10">
              ...
              <AnimatePresence mode="wait">
                {bookingState === 'idle' && (
                  ...
                  >
                    <div className="w-full bg-[#0a0a0a] border border-[#222] p-5 flex items-center justify-between mb-12 rounded-sm shadow-inner">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 gap-px bg-[#222] mb-16 border border-[#222]">
                ...
                {bookingState === 'form' && (
                  ...
                  >
                    ...
                    <form onSubmit={submitApplication} className="flex flex-col gap-6 flex-1">
                ...
                {bookingState === 'success' && (
                  ...
                  >
                    ...
                    <p className="text-gray-400 font-light text-sm leading-relaxed max-w-sm mb-12">
                      La tua richiesta per la {car.name} è stata sigillata nei nostri sistemi. Un nostro funzionario ti contatterà entro 1 ora lavorativa per il perfezionamento del contratto.
                    </p>
                    <button 
                      onClick={handleClose}
                      className="w-full py-6 bg-[#111] hover:bg-[#222] border border-[#333] text-white uppercase tracking-[0.2em] text-xs font-bold transition-colors"
                    >
                      Chiudi Finestra
                    </button>
                  </motion.div>
